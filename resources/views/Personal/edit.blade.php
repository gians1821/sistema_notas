...
<form method="POST" action="{{ route('Personal.update',$personal->id_personal)}}">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="id_personal" name="id_personal" value="{{$personal->id_personal}}" disabled>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('dNI') is-invalid @enderror " id="dNI" name="dNI" value="{{$personal->dNI}}" disabled>
        @error('dNI')
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('nombre') is-invalid @enderror" id="nombre" name="nombre" value="{{$personal->nombre}}" value="{{ old('nombre')}}" disabled>
        @error('nombre')
        <span class="invalid-feedback" role="alert">
            <strong>{{$message}}</strong>
        </span>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('apellido') is-invalid @enderror" id="apellido" name="apellido" value="{{$personal->apellido}}" value="{{ old('apellido')}}" disabled>
        @error('apellido')
        <span class="invalid-feedback" role="alert">
            <strong>{{$message}}</strong>
        </span>
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control @error('fecha_nacimiento') is-invalid @enderror" id="fecha_nacimiento" name="fecha_nacimiento" value="{{$personal->fecha_nacimiento}}" value="{{ old('fecha_nacimiento')}}" disabled>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('direccion') is-invalid @enderror" id="direccion" name="direccion" value="{{$personal->direccion}}" value="{{ old('direccion')}}">
        @error('direccion')
        <span class="invalid-feedback" role="alert">
            <strong>{{$message}}</strong>
        </span>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('telefono') is-invalid @enderror" id="telefono" name="telefono" value="{{$personal->telefono}}" value="{{ old('telefono')}}">
        @error('telefono')
        <span class="invalid-feedback" role="alert">
            <strong>{{$message}}</strong>
        </span>
