...
<body>
    ...
    <p><strong>Nombre del Curso:</strong> {{ $curso->nombre_curso ?? 'Desconocido' }}</p>
    </div>
    <div class="description">
        <p>Boleta de notas correspondiente al año escolar 2024. A continuación se presenta el detalle de las calificaciones obtenidas por los alumnos del programa académico.</p>
    </div>
    ...
    <div class="content">
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$nota->alumno_id_alumno}}</td>
                    <td>{{$nota->alumno->nombre_alumno}} {{$nota->alumno->apellido_alumno}}</td>
                    <td>{{$nota->nota1}}</td>
                    <td>{{$nota->nota2}}</td>
                    <td>{{$nota->nota3}}</td>
                </tr>
